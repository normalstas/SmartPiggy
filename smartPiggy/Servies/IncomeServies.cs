...
namespace smartPiggy.Servies
{
	class IncomeServies
	{
		const string Url = "http://192.168.0.104:5262/api/IncomeTables";
		...
		public static async Task<string> Post(IncomeTable inc)
		{
			using (var client = new HttpClient())
			{
				...
				var json = JsonConvert.SerializeObject(inc, new JsonSerializerSettings
				{
