...
{
    public class PiggyServies
    {
		const string Url = "http://192.168.0.104:5262/api/PiggyTables";
		...
		public static async Task<string> Post(PiggyTable piggy)
		{
			using (var client = new HttpClient())
			{
				...
				var json = JsonConvert.SerializeObject(piggy, new JsonSerializerSettings
				{
